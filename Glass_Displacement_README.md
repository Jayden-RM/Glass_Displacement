...
Control and analysis software for the Tandem PV Glass Displacement
measurement system.
...
![Last
Commit](https://img.shields.io/github/last-commit/jaydenig/Glass_Displacement/main)
...
<summary>
```
`<strong>`{=html}📑 Table of Contents`</strong>`{=html} (click to
expand)
```{=html}
</summary>
```
...
-   [Launching the
    Application](#launching-the-application-ipython-recommended)
...
Glass Displacement provides automated XY stage motion, laser
displacement sensing, and real-time visualization through a PyQt5
graphical interface. The software is designed for high-precision surface
mapping workflows in research and production environments.
...
*(Recommended --- add your screenshot for maximum polish)*

1.  Create a folder in your repo:

    docs/images/

2.  Save your screenshot as:

    docs/images/gui.png

3.  When ready, replace the commented line below with the image:
...
This project runs most reliably inside an Anaconda environment,
especially on Windows systems using PyQt5.
...
The scan uses a serpentine traversal pattern with stabilization delays
between moves.
...
-   Jayden --- Major modifications, stability improvements, and UI
    enhancements
